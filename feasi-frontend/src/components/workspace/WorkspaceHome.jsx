...
const CAPABILITY_CARDS = {
  grid_study:           { label: "Grid Study",           desc: "Network analysis and capacity assessment", icon: "M13 2L3 14h9l-1 8 10-12h-9l1-8z", color: "#7c5cfc" },
  ...
  dispatch_optimisation:{ label: "Dispatch Optimisation", desc: "Optimal energy dispatch scheduling", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", color: "#7c5cfc" },
...
const TECH_COLORS = {
  wind: "#5b8def", solar: "#f59e0b", bess: "#a78bfa", datacentre: "#6c5ce7", thermal: "#f97316",
};
...
const COST_CATEGORIES = [
  ...
  { label: "Equipment", planned: 12500, actual: 11200, color: "#7c5cfc" },
      ...
      <div className="wh-hub pd-dashboard">
        ...
        <div className="pd-kpi-strip">
          <KPICard label="Total Capacity" value={totalCapacity} unit="MW" delta={12} deltaLabel="vs last quarter"
            color="#7c5cfc" icon="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
